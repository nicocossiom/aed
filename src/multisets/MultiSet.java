...
public interface MultiSet<Element> {
   ...
   * as an argument
   * @throws IllegalArgumentException if n<0 or if there are fewer than n copies of elem in the set.
   */
   ...
   * the object multiset, and the argument multiset. 
  ...
  /**
   * Returns a new multiset corresponding to the removal of the 
   * elements in the argument from the object multiset.
