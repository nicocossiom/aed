...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Alejandro"),new String("Laura") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(1) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Ander") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] {  })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Mireia") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray())) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("*"),new String("*") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray())) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Antonio"),new String("Antonio"),new String("*") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(1),new Integer(1) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laura"),new String("*"),new String("*"),new String("*") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray())) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Carmen") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] {  })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("*"),new String("*"),new String("*") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(1),new Integer(1) }),new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(1),new Integer(2) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paloma"),new String("*") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray())) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Joana"),new String("*") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(2) }),new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(1) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Juan"),new String("Paula") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(3) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Julia"),new String("Julia") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray())) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laura"),new String("Antonio") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(1) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Lucia") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] {  })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Maria") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] {  })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Mikel") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] {  })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("*"),new String("*"),new String("Sara") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(4),new Integer(1) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Pablo") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] {  })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] {  })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new Search(tree,new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Teresa"),new String("Laura") })).doCall().checkResult(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.NodePositionList<Integer>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<Integer>(new Integer[] { new Integer(1) })))) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  es.upm.aedlib.tree.GeneralTree<String> tree = new es.upm.aedlib.tree.LinkedGeneralTree<String>() ;
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Alicia")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Alicia") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  es.upm.aedlib.Position<String> pos_0 = tree.addChildLast(root,new String("Antonio")) ;
  es.upm.aedlib.Position<String> pos_1 = tree.addChildLast(root,new String("Guillem")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Alicia"),new String("Antonio") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Alicia"),new String("Guillem") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  es.upm.aedlib.tree.GeneralTree<String> tree = new es.upm.aedlib.tree.LinkedGeneralTree<String>() ;
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Carmen")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Carmen") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  es.upm.aedlib.tree.GeneralTree<String> tree = new es.upm.aedlib.tree.LinkedGeneralTree<String>() ;
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Francesca")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Francesca") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Guillem"),new String("Paloma"),new String("Guillem") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Guillem"),new String("Ibai"),new String("Isabel") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  es.upm.aedlib.Position<String> pos_1 = tree.addChildLast(pos_0,new String("Marc")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Guillem"),new String("Oier"),new String("Marc") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Ibai"),new String("Leire") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Ibai"),new String("Marc") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Iker") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Iker"),new String("Antonio"),new String("Lucia") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Iker"),new String("Carmen") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Irati") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Isabel"),new String("Jordi"),new String("Iker") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Joana") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Joana"),new String("Carmen") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Joana"),new String("Isabel") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  es.upm.aedlib.tree.GeneralTree<String> tree = new es.upm.aedlib.tree.LinkedGeneralTree<String>() ;
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Jordi")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jordi") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jordi"),new String("Antonio"),new String("Jordi") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jordi"),new String("Pablo") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jordi") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jordi"),new String("Antonio"),new String("Guillem") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jordi"),new String("Pablo"),new String("Ander") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jose"),new String("Paula") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jose") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Jose"),new String("Leire") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  es.upm.aedlib.tree.GeneralTree<String> tree = new es.upm.aedlib.tree.LinkedGeneralTree<String>() ;
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Juan")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Juan") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Julia"),new String("Maria"),new String("Isabel") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Julia"),new String("Maria"),new String("Leire") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laia"),new String("Carmen"),new String("Manuel") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laia"),new String("Pedro"),new String("Carmen") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laia"),new String("Pedro"),new String("Leire") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laia"),new String("Pedro"),new String("Noa") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laura"),new String("Irati") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Laura"),new String("Francisco") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Lucia"),new String("Francisco"),new String("Jordi") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Lucia"),new String("Julia"),new String("Andreu") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Lucia"),new String("Julia") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Lucia"),new String("Julia"),new String("Paula") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Lucia"),new String("Francisco"),new String("Joana") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Manuel"),new String("Maria") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Manuel"),new String("Irati") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Manuel") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Marc") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Marc"),new String("Antonio") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Marc"),new String("Joana") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Marc"),new String("Teresa") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Marc") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  es.upm.aedlib.Position<String> pos_1 = tree.addChildLast(pos_0,new String("Isabel")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Marc"),new String("Pedro"),new String("Isabel") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Marc") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  es.upm.aedlib.Position<String> pos_0 = tree.addChildLast(root,new String("Laura")) ;
  es.upm.aedlib.Position<String> pos_1 = tree.addChildLast(root,new String("Francesca")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Maria") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Maria"),new String("Laura") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Maria"),new String("Francesca") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel"),new String("Ander"),new String("Leire") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel"),new String("Alejandro"),new String("Ane"),new String("Francesca") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel"),new String("Alejandro"),new String("Ane"),new String("Guillem") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel"),new String("Alejandro"),new String("Laia") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel"),new String("Alejandro"),new String("Ander") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel"),new String("Irati"),new String("Laura") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel"),new String("Alejandro"),new String("Ane") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Miguel") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  es.upm.aedlib.tree.GeneralTree<String> tree = new es.upm.aedlib.tree.LinkedGeneralTree<String>() ;
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Noa")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa"),new String("Francisco"),new String("Oier") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa"),new String("Paula") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa"),new String("Francisco"),new String("Maria") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa"),new String("Francisco") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa"),new String("Maria"),new String("Noa") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Noa"),new String("Maria"),new String("Andreu") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Oier")) ;
  es.upm.aedlib.Position<String> pos_0 = tree.addChildLast(root,new String("Leire")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Oier"),new String("Leire") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paloma") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula"),new String("Mikel"),new String("Ander") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula"),new String("Mikel"),new String("Ibai") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula"),new String("Isabel"),new String("Alicia") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula"),new String("Paula"),new String("Susana") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula"),new String("Paula") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula"),new String("Paula"),new String("Irati") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  es.upm.aedlib.Position<String> root = tree.addRoot(new String("Paula")) ;
  es.upm.aedlib.Position<String> pos_0 = tree.addChildLast(root,new String("Teresa")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Paula"),new String("Teresa") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  es.upm.aedlib.Position<String> pos_0 = tree.addChildLast(root,new String("Teresa")) ;
  es.upm.aedlib.Position<String> pos_1 = tree.addChildLast(pos_0,new String("Antonio")) ;
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Sara") }),new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Sara"),new String("Teresa"),new String("Antonio") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
if (ok_sofar)
{
  ...
  ok_sofar = new ConstructDeterministicTree(new es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>>(TestUtils.toGenericArray(new es.upm.aedlib.positionlist.NodePositionList<String>(new String[] { new String("Unai") })))).doCall().checkResult(tree) ;
}
return ok_sofar ;
}
) ;
...
static class ConstructDeterministicTree extends TestCall<es.upm.aedlib.tree.Tree<String>,es.upm.aedlib.tree.Tree<String>>
{
  ...
  public ConstructDeterministicTree (es.upm.aedlib.set.PositionListSet<es.upm.aedlib.positionlist.PositionList<String>> x_1)
  {
    this.x_1 = x_1 ;
    if (x_1 == null)
      x_1_orig = null ;
